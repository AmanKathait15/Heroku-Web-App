    ...
    def plot_PieChart(self):
        ...
        if(self.select_user() == "Compare All"):
            ...
            if(self.select_type() == 'polarity'):
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_polarity_pie.png', bbox_inches='tight')
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_emotion_pie.png', bbox_inches='tight')
        	    ...
        	    if(self.select_type() == "emotion"):
        	    	...
        	    	plt.savefig('image_resource/'+self.user.get()+'_'+self.theme.get()+'_emotion_pie.png',bbox_inches='tight')
        	    	...
        	    	plt.savefig('image_resource/'+str(self.user.get())+'_'+self.theme.get()+'_polarity_pie.png',bbox_inches='tight')
    ...
    def scatter_plot(self):
        ...
        if(self.select_user() == 'Compare All'):
            ...
            if(self.select_type() == 'polarity'):
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_polarity_scatter.png', bbox_inches='tight')
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_emotion_scatter.png', bbox_inches='tight')
            ...
            if(self.select_type() == 'polarity'):
                ...
                plt.savefig('image_resource/'+str(self.user.get())+'_'+self.theme.get()+'_polarity_scatter.png', bbox_inches='tight')
                ...
                plt.savefig('image_resource/'+str(self.user.get())+'_'+self.theme.get()+'_emotion_scatter.png', bbox_inches='tight')
    ...
    def plot_histogram(self):
        ...
        if(self.select_user() == 'Compare All'):
            ...
            if(self.select_type() == 'polarity'):
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_polarity_histogram.png', bbox_inches='tight')
                ...
                plt.savefig('image_resource/Compare_All_'+self.theme.get()+'_emotion_bar.png', bbox_inches='tight')
            ...
            if(self.select_type() == 'polarity'):
                ...
                plt.savefig('image_resource/'+str(self.user.get())+'_'+self.theme.get()+'_polarity_histogram.png', bbox_inches='tight')
                ...
                plt.savefig('image_resource/'+str(self.user.get())+'_'+self.theme.get()+'_emotion_bar.png', bbox_inches='tight')
